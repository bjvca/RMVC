...
saveRDS(balance, file= paste(path,"paper/results/balance.RData", sep="/"))
...
saveRDS(balance_farmer, file= paste(path,"paper/results/balance_farmer.RData", sep="/"))
saveRDS(F_test, file= paste(path,"paper/results/F_test.RData", sep="/"))
