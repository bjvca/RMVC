...
saveRDS(res_farmers, file= paste(path,"paper/results/res_farmers.RData", sep="/"))
...
saveRDS(res_farmers_sec_quant, file= paste(path,"paper/results/res_farmers_sec_quant.RData", sep="/"))
...
saveRDS(res_farmers_sec_uptake, file= paste(path,"paper/results/res_farmers_sec_uptake.RData", sep="/"))
...
saveRDS(res_farmers_sec_sold, file= paste(path,"paper/results/res_farmers_sec_sold.RData", sep="/"))
...
saveRDS(res_farmers_sec_switching, file= paste(path,"paper/results/res_farmers_sec_switching.RData", sep="/"))
...
ggsave( file= paste(path,"paper/results/forest_plot.png", sep="/"), plot = forest_plot, width = 10, height = 6, dpi = 300)
...
ggsave( file= paste(path,"paper/results/forest_plot_price.png", sep="/"), plot = forest_plot, width = 10, height = 6, dpi = 300)
...
print(forest_plot)
ggsave( file= paste(path,"paper/results/forest_plot_farmer_use_simple.png", sep="/"), plot = forest_plot, width = 10, height = 6, dpi = 300)
...
# Print the forest plot
print(forest_plot)
ggsave( file= paste(path,"paper/results/forest_plot_price_simple.png", sep="/"), plot = forest_plot, width = 10, height = 6, dpi = 300)
#####switching
...
# Print the forest plot
print(forest_plot)
ggsave( file= paste(path,"paper/results/forest_plot_swithing_simple.png", sep="/"), plot = forest_plot, width = 10, height = 6, dpi = 300)
...
saveRDS(res_MCCs, file= paste(path,"paper/results/res_MCCs.RData", sep="/"))
...
saveRDS(res_MCCs_sec_quant, file= paste(path,"paper/results/res_MCCs_sec_quant.RData", sep="/"))
...
saveRDS(res_MCCs_sec_uptake, file= paste(path,"paper/results/res_MCCs_sec_uptake.RData", sep="/"))
##secondary: MCC sales
...
saveRDS(res_MCCs_sec_sales, file= paste(path,"paper/results/res_MCCs_sec_sales.RData", sep="/"))
...
# Print the forest plot
print(forest_plot)
ggsave( file= paste(path,"paper/results/forest_plot_MCC_use_simple.png", sep="/"), plot = forest_plot, width = 10, height = 6, dpi = 300)
...
# Print the forest plot
print(forest_plot)
ggsave( file= paste(path,"paper/results/forest_plot_MCC_prices_simple.png", sep="/"), plot = forest_plot, width = 10, height = 6, dpi = 300)
...
saveRDS(res_samples, file= paste(path,"paper/results/res_samples.RData", sep="/"))
...
# Print the forest plot
print(forest_plot)
ggsave( file= paste(path,"paper/results/forest_plot_samples_simple.png", sep="/"), plot = forest_plot, width = 10, height = 6, dpi = 300)
...
# Print the plot
plot(cum_dist)
ggsave(paste(path,"paper/results/distribution_of_delivery.png",sep="/"))
...
saveRDS(assorted_tests, file= paste(path,"paper/results/assorted_tests.RData", sep="/"))
